...
<body>
    ...
    <h5 style="margin-left: 10px;"><a href="homepage.php"  onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        ...
        &nbsp;&nbsp;&nbsp;Girls > 
        <a href="kids-girls.php"onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        &nbsp;&nbsp;&nbsp;All</a></h5>
    </div>


    <div class="col-md-12" style="height: 50px; background-color: rgb(255, 255, 255);">
    <h4 style="margin-top: 20px;"><b><center>All</center></b></h4>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                ...
                <a href =" "><img src="h-img/girls3.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
            </br>
                <a href =" "><img src="h-img/girls4.jpg" class="img-responsive " ></a>
            </div>

            <div class="col-md-3">
            </br>
                <center><b> Girls grey dress</b> </center> </br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Girls purple shirt</b> </center> </br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Kids Blue frock</b> </center> </br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Girls brown coat</b> </center> </br>
      ...
      <div class="col-md-12">
            ...
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls5.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls6.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls7.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls8.jpg" class="img-responsive " ></a>
            </div>

            <div class="col-md-3">
            </br>
                <center><b> Girls blue jeans</b> </center> </br>
                    <div class = "col-md-4"  >   ̶ ̶R̶s̶ ̶1̶0̶3̶0̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Girls white shirt</b> </center> </br>
                    <div class = "col-md-4"  >   ̶̶R̶s̶ ̶2̶2̶9̶5̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
            ...
            <div class="col-md-3">
                ...
                <center><b>  GIrls grey coat shoes</b> </center> </br>
                    <div class = "col-md-4"  > ̶̶R̶s̶ ̶2̶3̶0̶0̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Girls black bag</b> </center> </br>
                    <div class = "col-md-4"  > ̶̶R̶s̶ ̶2̶4̶0̶0̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls9.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls10.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls11.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/girls12.jpg" class="img-responsive " ></a>
            </div>

            <div class="col-md-3">
            </br>
                <center><b> Girls brown maxi</b> </center> </br>
                    <div class = "col-md-4"  >   ̶ ̶R̶s̶ ̶1̶0̶3̶0̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Girls black Frock</b> </center> </br>
                    <div class = "col-md-4"  >   ̶̶R̶s̶ ̶2̶2̶9̶5̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Girls blue wide jeans</b> </center> </br>
                    <div class = "col-md-4"  > ̶̶R̶s̶ ̶2̶3̶0̶0̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Girls yellow frock</b> </center> </br>
                    <div class = "col-md-4"  > ̶̶R̶s̶ ̶2̶4̶0̶0̶ </div> 
                    <div class = "col-md-4" style="color: red; ">  Rs 999    </div>
                    <div class = "col-md-4">   </div>
                </br></br>
