...
<body>
  ...
  <div class="modal fade" id="Model2">
    ...
    <h5 style="margin-left: 10px;"><a href="homepage.php"  onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        ...
        &nbsp;&nbsp;&nbsp;Clothing > 
        <a href="men-shirts.php"onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        &nbsp;&nbsp;&nbsp;Shirts</a></h5>
    </div>


    <div class="col-md-12" style="height: 50px; background-color: rgb(255, 255, 255);">
    <h4 style="margin-top: 20px;"><b><center>SHIRTS</center></b></h4>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                ...
                <a href =" "><img src="h-img/men10.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
            </br>
                <a href =" "><img src="h-img/men11.jpg" class="img-responsive " ></a>
            </div>

            <div class="col-md-3">
            </br>
                <center><b> West Line Men Casual Checked Shirt</b> </center> </br>
      ...
      <div class="col-md-12">
            ...
            <div class="col-md-3">
                <a href =" "><img src="h-img/men12.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/men13.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/men14.jpg" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
                <a href =" "><img src="h-img/men15.jpg" class="img-responsive " ></a>
            </div>
