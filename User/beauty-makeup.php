...
<body>
  ...
  <div class="modal fade" id="Model2">
    ...
    <h5 style="margin-left: 10px;"><a href="homepage.php"  onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        ...
        &nbsp;&nbsp;&nbsp;Beauty > 
        <a href="beauty-makeup.php"onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        &nbsp;&nbsp;&nbsp;Makeup</a></h5>
    </div>


    <div class="col-md-12" style="height: 50px; background-color: rgb(255, 255, 255);">
    <h4 style="margin-top: 20px;"><b><center>Makeup</center></b></h4>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                ...
                <a href =" "><img src="h-img/beauty6.png" class="img-responsive " ></a>
            </div>
        
            <div class="col-md-3">
            </br>
                <a href =" "><img src="h-img/beauty8.png" class="img-responsive " ></a>
            </div>

            <div class="col-md-3">
            </br>
                <center><b> HUDA beauty lipgloss</b> </center> </br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Revolution makeup</b> </center> </br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Revolution tint</b> </center> </br>
            ...
            <div class="col-md-3">
                ...
                <center><b> Power brow mascara</b> </center> </br>
