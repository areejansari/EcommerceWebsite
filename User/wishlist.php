...
<body>
  ...
  <div class="modal fade" id="Model2">
    ...
    <h5 style="margin-left: 10px;"><a href="homepage.php"  onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        &nbsp;&nbsp;&nbsp;Home </a>> 
        <a href="wishlist.php" onMouseOver="this.style.color='#4169E1'" onMouseOut="this.style.color='#000000'"> 
        &nbsp;&nbsp;&nbsp;Wishlist </a> >
    ...
    <h3 style="margin-top: 20px;"><b><center>W I S H L I S T</center></b></h3>
    </div>
