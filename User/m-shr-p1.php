...
<img src="h-img/men8.jpg" class="img-responsive " style= "width: 270px; height: 400px; margin-left: 50px; margin-top: 30px;">
</div>


<div class="col-md-6" style=" margin-top: 50px;">

<h3><b> Men Casual Checked Shirt</b></h3>
<h5 style="color: grey;">STYLE : TSH-AHM-SHZ-BUBBLE-SILVER</h5>
</br>
<div class="col-md-12">
<div class = "col-md-2" style="color: grey; " ><b><h5> ̶R̶s̶ ̶1̶09̶9̶  </h5> </b> </div> 
