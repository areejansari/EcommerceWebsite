    ...
    <div class="container cart">
        <table>
          ...
          <tr>
            <td>
              <div class="cart-info">
                <img src="h-img/a (12).jpg" alt="" />
                <div style="padding-top: 1rem;">
                    <h5 class="text-uppercase">BABY LOONEY TUNES GRAPHIC OVERSIZED TEE</h5>
                  <span>Price: RS.999</span> <br />
        ...
        <div class="total-price">
          ...
          <a href="buynow.php"><button style="width: 400px; height: 40px; font-size: 15px;" class="buy-now"> Check Out</button></a>
        </div>
      </div>
